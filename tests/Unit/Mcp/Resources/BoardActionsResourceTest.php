...
final class BoardActionsResourceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = new BoardActionsResource($this->actionService, $this->apiKeyProvider);
    }
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->actionService->method('getBoardActions')->willThrowException(new AuthenticationException('Unauthorized'));
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->actionService->method('getBoardActions')->willThrowException(new PlankaApiException('Server error'));

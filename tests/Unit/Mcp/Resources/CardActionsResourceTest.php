...
final class CardActionsResourceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = new CardActionsResource($this->actionService, $this->apiKeyProvider);
    }
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->actionService->method('getCardActions')->willThrowException(new AuthenticationException('Unauthorized'));
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->actionService->method('getCardActions')->willThrowException(new PlankaApiException('Server error'));

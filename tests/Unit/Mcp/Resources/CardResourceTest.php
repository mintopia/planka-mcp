...
final class CardResourceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = new CardResource($this->cardService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->cardService->method('getCard')->willReturn(['item' => ['id' => 'card1']]);
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->cardService->method('getCard')->willThrowException(new AuthenticationException('Unauthorized'));
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->cardService->method('getCard')->willThrowException(new PlankaApiException('Server error'));

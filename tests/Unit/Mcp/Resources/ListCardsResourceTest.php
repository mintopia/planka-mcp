...
final class ListCardsResourceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = new ListCardsResource($this->listService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->listService->method('getListCards')->willReturn(['items' => []]);

        $response = $this->resource->handle($this->makeRequest(['listId' => 'list1']));
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->listService->method('getListCards')->willThrowException(new AuthenticationException('Unauthorized'));
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->listService->method('getListCards')->willThrowException(new PlankaApiException('Server error'));

...
final class ListResourceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = new ListResource($this->listService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->listService->method('getList')->willReturn(['item' => ['id' => 'list1']]);
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->listService->method('getList')->willThrowException(new AuthenticationException('Unauthorized'));
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->listService->method('getList')->willThrowException(new PlankaApiException('Server error'));

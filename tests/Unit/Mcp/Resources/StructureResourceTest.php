...
final class StructureResourceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = new StructureResource($this->projectService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->projectService->method('getStructure')->willReturn(['items' => []]);
    ...
    {
        $this->apiKeyProvider->method('getApiKey')->willReturn('test-key');
        $this->projectService->method('getStructure')->willThrowException(new PlankaApiException('Server error'));

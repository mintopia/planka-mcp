...
final class DeleteCommentToolTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tool = new DeleteCommentTool($this->commentService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->commentService->method('deleteComment')->willReturn([]);

        $response = $this->tool->handle($this->makeRequest(['commentId' => 'cm1']));

...
final class DeleteTaskListToolTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tool = new DeleteTaskListTool($this->taskService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->taskService->method('deleteTaskList')->willReturn([]);

...
final class DeleteTaskToolTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tool = new DeleteTaskTool($this->taskService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->taskService->method('deleteTask')->willReturn([]);

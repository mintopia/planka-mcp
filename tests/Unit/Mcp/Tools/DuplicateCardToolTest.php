...
final class DuplicateCardToolTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tool = new DuplicateCardTool($this->cardService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->cardService->method('duplicateCard')->willReturn(['item' => ['id' => 'c2']]);

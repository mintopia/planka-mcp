...
final class GetCardToolTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tool = new GetCardTool($this->cardService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->cardService->method('getCard')->willReturn(['item' => ['id' => 'c1']]);

...
final class MarkAllNotificationsReadToolTest extends TestCase
{
    ...
    private MarkAllNotificationsReadTool $tool;
    ...
    protected function setUp(): void
    {
        ...
        $this->tool = new MarkAllNotificationsReadTool($this->notificationService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->notificationService->method('readAllNotifications')->willReturn([]);

...
final class UpdateCommentToolTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tool = new UpdateCommentTool($this->commentService, $this->apiKeyProvider);
    }
    ...
    public function testHandleSuccess(): void
    {
        ...
        $this->commentService->method('updateComment')->willReturn(['item' => ['id' => 'cm1']]);

        $response = $this->tool->handle($this->makeRequest(['commentId' => 'cm1', 'text' => 'Updated']));
        $this->assertFalse($response->isError());
    }

    public function testHandleEmptyText(): void
    {
        $response = $this->tool->handle($this->makeRequest(['commentId' => 'cm1', 'text' => '']));
    ...
    public function testHandleAuthError(): void
    {
        ...
        $response = $this->tool->handle($this->makeRequest(['commentId' => 'cm1', 'text' => 'Hi']));
        $this->assertTrue($response->isError());
    }
